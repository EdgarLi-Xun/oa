...
//     Cookies.set(USER_INFO_KEY, userInfo, { expires: cookieExpires || 1 })
// }
//
...
export const setAuthList = (authList) =>{
  localSave(AUTH_LIST,authList);
}

export const getAuthList = () => {
  const authList = localRead(AUTH_LIST)
  if (authList && authList != 'null') return authList
  else return false
}
