...
import com.sega.application.oa.base.CustomUnauthorizedException;
...
public class AesUtil {
    ...
    public static String encode(String str) {
        try {
            ...
            return Base64Util.encodeThrowsException(parseByte2HexStr(cipherByte));
    ...
    public static String decode(String str) {
        try {
            ...
            byte[] cipherByte = c.doFinal(parseHexStr2Byte(base64));
